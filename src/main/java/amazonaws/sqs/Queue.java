...
import amazonaws.sqs.generated.CreateQueueResponse;
import amazonaws.sqs.generated.DeleteMessageResponse;
import amazonaws.sqs.generated.DeleteQueueResponse;
import amazonaws.sqs.generated.ErrorResponse;
import amazonaws.sqs.generated.Error;
import amazonaws.sqs.generated.GetQueueAttributesResponse;
import amazonaws.sqs.generated.ListQueuesResponse;
import amazonaws.sqs.generated.ReceiveMessageResponse;
import amazonaws.sqs.generated.SendMessageResponse;
import amazonaws.sqs.generated.SetQueueAttributesResponse;
import amazonaws.sqs.util.QMessage;
import amazonaws.sqs.util.QueueAttribute;
import amazonaws.sqs.util.QueueException;
import amazonaws.sqs.util.SQSClient;
import amazonaws.sqs.util.Translator;
...
public class Queue {
    ...
    static public Queue createQueue(String name) throws Exception {
        SQSClient sqsClient = new SQSClient(SampleDriver.QueueServiceURL);
    ...
    public void deleteMessageList(List<String> receiptHandles) throws Exception {
        SQSClient sqsClient = new SQSClient(queueEndpoint);
        sqsClient.setAction("DeleteMessageBatch");
        int pos = 0;
        for(String receiptHandle : receiptHandles ){
        	++pos;
        	sqsClient.addQueryParam("DeleteMessageBatchRequestEntry."+ String.valueOf(pos) +".ReceiptHandle", receiptHandle);
        	sqsClient.addQueryParam("DeleteMessageBatchRequestEntry."+ String.valueOf(pos) +".Id", "msg_id_" + String.valueOf(pos));
        }
        // make the call
//        Object response = sqsClient.callAndUnmarshal();
        sqsClient.callBatch();
/*        
    ...
    public void sendMessageList(List<String> messages) throws Exception {
        SQSClient sqsClient = new SQSClient(queueEndpoint);
        sqsClient.setAction("SendMessageBatch");
        int pos = 0;
        for(String messsage : messages ){
        	++pos;
        	sqsClient.addQueryParam("SendMessageBatchRequestEntry."+ String.valueOf(pos) +".MessageBody", messsage);
        	sqsClient.addQueryParam("SendMessageBatchRequestEntry."+ String.valueOf(pos) +".Id", "msg_id_" + String.valueOf(pos));
        }
        // make the call
//        Object response = sqsClient.callAndUnmarshal();
        sqsClient.callBatch();
