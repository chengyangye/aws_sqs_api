...
public class GetQueueAttributes {
    ...
    @XmlElement(name = "AttributeName", namespace = "http://queue.amazonaws.com/doc/2012-11-05/", required = true)
    protected List<String> attributeName;
    @XmlElement(name = "Unused", namespace = "http://queue.amazonaws.com/doc/2012-11-05/")
