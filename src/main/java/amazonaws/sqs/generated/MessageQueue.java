...
import amazonaws.sqs.generated.MessageQueuePortType;
import amazonaws.sqs.generated.MessageQueuePortType;
...
@WebServiceClient(name = "MessageQueue", targetNamespace = "http://queue.amazonaws.com/doc/2012-11-05/", wsdlLocation = "file:/tmp/20080101/QueueService_20080101.wsdl")
public class MessageQueue extends Service {

    private final static URL WSDL_LOCATION;
    private final static QName SERVICE = new QName("http://queue.amazonaws.com/doc/2012-11-05/", "MessageQueue");
    private final static QName MessageQueueHttpsPort = new QName("http://queue.amazonaws.com/doc/2012-11-05/", "MessageQueueHttpsPort");
    private final static QName MessageQueuePort = new QName("http://queue.amazonaws.com/doc/2012-11-05/", "MessageQueuePort");
    static {
        URL url = null;
        try {
