...
public class Message {
    ...
    @XmlElement(name = "ReceiptHandle", namespace = "http://queue.amazonaws.com/doc/2012-11-05/", required = true)
    protected String receiptHandle;
    @XmlElement(name = "MD5OfBody", namespace = "http://queue.amazonaws.com/doc/2012-11-05/", required = true)
    protected String md5OfBody;
    @XmlElement(name = "Body", namespace = "http://queue.amazonaws.com/doc/2012-11-05/", required = true)
