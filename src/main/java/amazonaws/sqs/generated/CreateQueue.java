...
public class CreateQueue {
    ...
    @XmlElement(name = "QueueName", namespace = "http://queue.amazonaws.com/doc/2012-11-05/", required = true)
    protected String queueName;
    @XmlElement(name = "DefaultVisibilityTimeout", namespace = "http://queue.amazonaws.com/doc/2012-11-05/")
